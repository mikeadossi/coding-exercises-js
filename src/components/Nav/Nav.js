...
export default class Nav extends React.Component{
  render(){
    ...
    <button className="nav_link incomplete" onClick={()=>this.props.pageChange("braille_page")}>braille</button>
      <button className="nav_link" onClick={()=>this.props.pageChange("string_permutations_page")}>string permutations</button>
    <button className="nav_link incomplete" onClick={()=>this.props.pageChange("finite_state_gate_page")}>finite state gate</button>

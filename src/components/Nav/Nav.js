  ...
  render(){
    return(
      ...
      <button className="nav_link" onClick={()=>this.props.pageChange("the_disemvowing_page")}>the disemvowing</button>
        ...
        <button className="nav_link" onClick={()=>this.props.pageChange("parents_B_Gone_page")}>parents b gone</button>
        <button className="nav_link" onClick={()=>this.props.pageChange("resolving_Symlinks_page")}>resolving symlinks</button>
